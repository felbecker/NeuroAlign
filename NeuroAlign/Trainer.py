    ...
    def __init__(self, config, predictor):
        ...
        def train_step(sequence_graph, col_priors, len_seqs,
            ...
            with tf.GradientTape() as tape:
                n_rp, c_rp, rel_occ, mem_logits = self.predictor.model(sequence_graph, col_priors, config["train_mp_iterations"])
                ...
                train_loss = l_node_rp + l_col_rp + l_rel_occ + l_mem_logs + regularizer(self.predictor.model.trainable_variables)
