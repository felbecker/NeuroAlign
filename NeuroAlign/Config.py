...
config = {
    ...
    "train_seq_iterations_per_col" : 10,
    "test_col_iterations" : 3,
    "test_alpha_iterations_per_col" : 2,
    "test_seq_iterations_per_col" : 10,
    ...
    "alphabet_latent_dim" : 16,

    "alphabet_net_node_layers" : [16, 16],
    "alphabet_net_edge_layers" : [16, 16],
    "alphabet_net_global_layers" : [16],

    "alphabet_to_sequence_layers" : [16],
    "alphabet_to_column_layers" : [16],
