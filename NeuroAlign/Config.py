...
config = {
    ...
    "alphabet_latent_dim" : 64,

    "alphabet_net_node_layers" : [64, 64, 64],
    "alphabet_net_edge_layers" : [64, 64, 64],
    "alphabet_net_global_layers" : [64, 64, 64],

    "alphabet_to_sequence_layers" : [64, 64],
    "alphabet_to_column_layers" : [64, 64],
    ...
    "seq_net_node_layers" : [64, 64, 64],
    "seq_net_edge_layers" : [64, 64, 64],
    "seq_net_global_layers" : [64, 64, 64],

    "sequence_to_column_layers" : [64, 64],
    "sequence_to_alphabet_layers" : [64, 64],

    #hidden dimension for the latent representation of the global property of each column
    "col_latent_dim" : 64,

    "column_net_node_layers" : [64, 64, 64, 64],
    "column_net_global_layers" : [64, 64, 64, 64],
    "column_encode_node_layers" : [64],
    "column_decode_node_layers" : [64, 64, 64],

    "column_to_sequence_layers" : [64, 64],
    "column_to_alphabet_layers" : [64, 64]
}
